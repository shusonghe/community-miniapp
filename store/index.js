...
let saveStateKeys = ['vuex_user', 'vuex_tabbar_config']
...
const store = new Vuex.Store({
  state: {
    ...
    vuex_user: lifeData.vuex_user ? lifeData.vuex_user : {name: '珈邻用户'},
    ...
    // tabbar动态配置
    vuex_tabbar_config: lifeData.vuex_tabbar_config ? lifeData.vuex_tabbar_config : null,
    // tabbar配置加载状态
    vuex_tabbar_loaded: false
  },
  mutations: {
